...
const std::string KABOOM_FILE_NAME{ "images\\heart (1).png" };
const std::string  MEDKIT_FILE_NAME{ "images\\heart (1).png" };
const std::string SPEED_BOOST_FILE_NAME{ "images\\heart (1).png" };
